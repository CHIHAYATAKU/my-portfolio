                ...
                <div className={styles.container}>
                    <div className={styles.text}>
                        ...
                        <div className={styles.divVideoes}>
                            <video className={styles.video} src={require('./UnivClab_Videoes/tabiji.mp4')} controls playsinline />
                            <video className={styles.video} src={require('./UnivClab_Videoes/lupin.mp4')} controls playsinline />
                        </div>
                    </div>
                </div>
            </section >
