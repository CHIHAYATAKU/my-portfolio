        ...
        <>
            <section className='section'>
                <div className={styles.container}>
                    ...
                    <p>私の技術スタックです．私の主観的な評価で入門，応用，実践レベルの3つに分けています．<br />
                    </p>
                    <div className={styles.level_container}>
                        <div className={styles.levelblock}>
                            <h3 className={`${styles.kihon} ${styles.h3}`}>基本レベル</h3>
                        ...
                        <div className={styles.levelblock}>
                            <h3 className={`${styles.hyoujun} ${styles.h3}`}>標準レベル</h3>
                        ...
                        <div className={styles.levelblock}>
                            <h3 className={`${styles.ouyou} ${styles.h3}`}>応用レベル</h3>
